class TestSpecInspectorMethods(unittest.TestCase):
    ...
    def test__ensure_no_undocumented_objects(self):
        spec = {'users': {'foo': {}}}
        current_state = {'users': {'foo': {},
                                   'bar': {}}, 'groups': {'baz': {}}}
        self.assertEqual(ensure_no_undocumented_objects(spec, current_state), [UNDOCUMENTED_OBJECTS_MSG.format(
            "users", "\"bar\""), UNDOCUMENTED_OBJECTS_MSG.format("groups", "\"baz\"")])
