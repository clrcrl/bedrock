...
UNDOCUMENTED_OBJECTS_MSG = ('Spec error: Undocumented {0} found: {1}.\n'
            ...
            if v.errors:
                ...
                for error_path_list, error in unpack_error_messages(error_dict):
                    ...
                    error_messages.append(
                        VALIDATION_ERR_MSG.format(error_path, error))
...
def ensure_no_undocumented_objects(spec, current_state):
    ...
    for object_type, objects in current_state.items():
        ...
        if undocumented_objects:
            ...
            error_messages.append(UNDOCUMENTED_OBJECTS_MSG.format(
                object_type, undocumented_objects_fmtd))
